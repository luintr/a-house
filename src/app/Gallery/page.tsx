		...
		<main onMouseMove={e => manageMouseMove(e)} className={styles.main}>
			<div ref={plane1} className={styles.plane}>
				<Image
					...
					alt='image'
					width={150}
					ref={element => imgRefs.setRef("0", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={175}
					ref={element => imgRefs.setRef("1", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={200}
					ref={element => imgRefs.setRef("2", element)}
				/>
			</div>
			<div ref={plane2} className={styles.plane}>
				<Image
					...
					alt='image'
					width={200}
					ref={element => imgRefs.setRef("3", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={225}
					ref={element => imgRefs.setRef("4", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={250}
					ref={element => imgRefs.setRef("5", element)}
				/>
			</div>
			<div ref={plane3} className={styles.plane}>
				<Image
					...
					alt='image'
					width={225}
					ref={element => imgRefs.setRef("6", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={300}
					ref={element => imgRefs.setRef("7", element)}
				/>
				<Image
					src={ImageData[0]}
					alt='image'
					width={300}
					ref={element => imgRefs.setRef("8", element)}
				/>
			</div>
		</main>
	);
